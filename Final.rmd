...
effectivenessgal = Femalesfish$estimate/(Femalesfish$estimate +1)*100
print(effectivenessgal)
```

```{r}
low=(Females$conf.int[1]/(Femalesfish$conf.int[1] +1))*100
hi=(Females$conf.int[2]/(Femalesfish$conf.int[2] +1))*100
options(digits=2)
```
...
This plot represents the population of those who are part of the LGBTQ community and the relationship to the contraction of covid-19 by taking either the vaccine or the placebo.

In this barplot, it appears that 71% of the individuals that took the vaccine got covid-19 as well as the 29% who received the placebo. The odds of getting covid-19 while taking the vaccine is 2.5:1. The individuals who identified as gay and took the vaccine were three times as likely to get covid-19 than those taking the placebo.
...
These numerical results shows percentages of people who are LGBTQ  individuals that got covid-19 after taking the placebo and taking the vaccine. 
The LGBTQ participants that took the vaccine and contracted covid-19 was at an approximate 71%. Those participants that only received the placebo only contacted covid-19 at 29%. The vaccine is evidently ineffective in protecting the LGBTQ community against covid-19 and it is not good to take it at all. 
The odds of getting covid-19 while taking the vaccine is 2.5:1. The individuals who identified as part of the LGBTQ community and took the vaccine were three times as likely to get covid-19 than those taking the placebo.

### Inferential 


The p-value is 6e-06. This in an incredibly small number and with that being said, the conclusion is that these results are unlikely to occur by chance.The Fishers's Exact Test illustrates that the odds ratio is 0.4
LGBTQ individuals who got the vaccine were about 2.5 times more likely to get Covid-19 than gays that took the placebo.The null hypothesis is rejected in favor the the alternative. The drug is completely ineffective in preventing the chances of getting covid-19 in individuals who identify as LGBTQ.
...
```{r}
low=(LGBTQ$conf.int[1]/(LGBTQ$conf.int[1] +1))*100
hi=(LGBTQ$conf.int[2]/(LGBTQ$conf.int[2] +1))*100
options(digits=2)
```
...
The odds ratio is approximately how effective the vaccine is. The odds ratio for the LGBTQ community can be seen above as 29. This is completely ineffective. The effectiveness confidence interval for the people who identified as LGBTQ is 20.51 to 37.97.
...
```{r}
low=(Druguser$conf.int[1]/(FinalDat$conf.int[1] +1))*100
hi=(Druguser$conf.int[2]/(FinalDat$conf.int[2] +1))*100
options(digits=2)
```
...
The odds ratio is approximately how effective the vaccine is. The odds ratio for the drug users can be seen above as 8. The effectiveness confidence interval for the drug users is 1:2.


##Final Summary

If you are a male or identify as LGBTQ it is not recommended to receive the vaccine. However, if you are a female or a drug user, the vaccine was reported to have been effective.
The null that there is no difference in taking the vaccine can be accepted to the categories including men and LGBTQ individuals. the alternative, that the vaccine works and is effective, can be accepted for the women, and the people who used drugs.
